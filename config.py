...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            barge_in_rms_threshold=_int_env("BARGE_IN_RMS_THRESHOLD", 40),
            ...
            barge_in_echo_residual_rms=_int_env("BARGE_IN_ECHO_RESIDUAL_RMS", 40),
            ...
            barge_in_warmup_rms_threshold=_int_env("BARGE_IN_WARMUP_RMS_THRESHOLD", 60),
